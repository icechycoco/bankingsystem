...
public class transfer_account extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/v/banner1.jpg"))); // NOI18N

        jLabel12.setText("account-account");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        **/
        ...
        service.serviceTransferAccSend(Long.parseLong(id.getText()), Integer.parseInt(amount.getText()));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        ServiceBank service = new Transfer();
            BankAccount info = BankAccount.search(Long.parseLong(id.getText()));
